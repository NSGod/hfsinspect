...
ssize_t hfs_read            (void* buffer, const HFSPlus* hfs, size_t size, off_t offset) __attribute__((nonnull));
...
ssize_t hfs_read_fork_range (void* buffer, const HFSPlusFork* fork, size_t size, off_t offset) __attribute__((nonnull));
